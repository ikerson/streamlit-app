...
with col2:
    ...
    segment_likelihood = f'''<html>
                                <p style="color:{right_bar_color}; font-size:20px; text-align:center;">Likelihood that <mark>{race_val}s</mark> who <mark>{lower_internet_val}</mark> have internet avalibilty and live in a household with an income of <mark>{income_val}</mark> had virtual contact with a teacher <mark>four or more times</mark> per week.</p>
                            </html>
                        '''
